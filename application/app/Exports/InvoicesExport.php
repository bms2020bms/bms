            ...
            foreach (request('standard_field') as $key => $value) {
                if ($value == 'on') {
                    ...
                    case 'bill_projectid':
                        ...
                        break;
                    case 'bill_subtotal':
                        $map[] = runtimeExcelNumberFormat($invoices->bill_subtotal);
                        break;
                    ...
                    case 'bill_discount_amount':
                        $map[] = runtimeExcelNumberFormat($invoices->bill_discount_amount);
                        break;
                    case 'bill_amount_before_tax':
                        $map[] = runtimeExcelNumberFormat($invoices->bill_amount_before_tax);
                        break;
                    case 'bill_tax_total_amount':
                        $map[] = runtimeExcelNumberFormat($invoices->bill_tax_total_amount);
                        break;
                    case 'bill_adjustment_description':
                        $map[] = $invoices->bill_adjustment_description;
                        break;
                    case 'bill_adjustment_amount':
                        $map[] = runtimeExcelNumberFormat($invoices->bill_adjustment_amount);
                        break;
                    case 'bill_final_amount':
                        $map[] = runtimeExcelNumberFormat($invoices->bill_final_amount);
                        break;
                    case 'bill_recurring':
